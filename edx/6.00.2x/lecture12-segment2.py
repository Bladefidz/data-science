...
# As we seen, since crocodile's legs is 4 which caused crocodile similar to
# chicken or dart forg rather that to other reptile such as cobra or boa
# To solve that, we can utilize a weighting method
def zScaleFeatures(vals):
    """Assumes vals is a sequences of floats"""
